...
public class EarthquakeCityMap extends PApplet {
	...
	private boolean isLand(PointFeature earthquake) {
		...
		// loop over all countries to check if location is in any of them using the helper method isInCountry
	...
	// Commenting the printQuakes when running the program
	/*private void printQuakes() {
		...
		for(Marker country : countryMarkers){
			...
			if(land>=1){
				System.out.println(country.getProperty("name").toString() +": " + land);
				}
			}
		System.out.println("OCEAN QUAKES: "+ (quakeMarkers.size()-(countland)));
		}*/
